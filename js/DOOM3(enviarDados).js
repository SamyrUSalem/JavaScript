function register(x) {
    //Esse x é o dado q o parâmetro "this.parentNODE" q esta no html coletou, no momento seria a section q é o pai da tag button, esse children(abaixo) é para referenciar q quero um filho dessa tag e o username é o id da tag filho q quero, e o value é para pegar o valor desse elemento 
